...
PROJECTMADHOUSE.ServiceWorkerRegistration = (function () {
  'use strict';
    ...
    if (!isAlreadyRegistered) {
      ...
      if ('serviceWorker' in navigator) {
        navigator.serviceWorker.register(URL, {
          ...
          PROJECTMADHOUSE.Analytics.trackError('navigator.serviceWorker.register() error', e);
  ...
  if (navigator.serviceWorker && navigator.serviceWorker.controller) {
    navigator.serviceWorker.controller.onstatechange = function (event) {
      if (event.target.state === 'redundant') {
        ...
        if (PROJECTMADHOUSE.Elements && PROJECTMADHOUSE.Elements.Template &&
          PROJECTMADHOUSE.Elements.Template.$.toast.show) {
          PROJECTMADHOUSE.Elements.Template.$.toast.show(
